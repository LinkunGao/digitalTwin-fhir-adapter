...
class Patient(AbstractResource, ABC):
    ...
    def get(self):
        patient = {
            ...
            "deceasedBoolean": self.deceased.get()["deceasedBoolean"] if isinstance(self.deceased, Deceased) else None,
            "deceasedDateTime": self.deceased.get()["deceasedDateTime"] if isinstance(self.deceased,
                                                                                      Deceased) else None,
            ...
            "multipleBirthBoolean": self.multiple_brith.get()["multipleBirthBoolean"] if isinstance(self.multiple_brith,
                                                                                                    MultipleBrith) else None,
            "multipleBirthInteger": self.multiple_brith.get()["multipleBirthInteger"] if isinstance(self.multiple_brith,
                                                                                                    MultipleBrith) else None,
